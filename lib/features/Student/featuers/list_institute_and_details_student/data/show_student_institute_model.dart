...
class ShowStudentInstituteModel {
  List<AcademyInfo>? academyInfo;

  ShowStudentInstituteModel({this.academyInfo});

  ShowStudentInstituteModel.fromJson(Map<String, dynamic> json) {
    if (json['Academy_info'] != null) {
      academyInfo = (json['Academy_info'] as List).map((v) => AcademyInfo.fromJson(v)).toList();
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.academyInfo != null) {
      data['Academy_info'] = this.academyInfo?.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
...
class AcademyInfo {
  ...
  AcademyInfo.fromJson(Map<String, dynamic> json) {
    ...
    this.image1 = File(json['image1']);
    this.image2 = File(json['image2']);
    this.image3 = File(json['image3']);
    this.image4 = File(json['image4']);
